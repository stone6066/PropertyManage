...
-(void)stdInitTxtF:(UITextField*)txtF hintxt:(NSString*)hintstr{
    ...
    txtF.textColor=[UIColor whiteColor];
    ...
    txtF.attributedPlaceholder=[[NSAttributedString alloc]initWithString:hintstr attributes:@{NSForegroundColorAttributeName: [UIColor whiteColor]}];
    txtF.delegate=self;
}
