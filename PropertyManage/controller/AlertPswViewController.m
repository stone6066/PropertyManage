...
-(void)addMendToSrv{
    ...
    //http://192.168.0.21:8080/propies/user/userupdate?userId=1&userPwdOld=aaaaaa&userPwdNew=bbbbbb
    NSString *urlstr=[NSString stringWithFormat:@"%@%@%@%@%@%@%@",BaseUrl,@"propies/user/userupdate?userId=",ApplicationDelegate.myLoginInfo.userId,@"&userPwdOld=",_oldPsw.text,@"&userPwdNew=",_onePsw.text];
